...
curl.exe -X POST "http://localhost:8081/data/access" -d "{\"entity\":\"MeaQuantity\"}" --header "Content-Type: application/json" --header "Accept: application/json"
